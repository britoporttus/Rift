...
const KB: KbEntry[] = [
  {
    title: 'Cross-Site Scripting (XSS)', cwe: ['79'], owasp: ['3'],
  ...
  {
    title: 'SQL Injection', cwe: ['89'], owasp: ['3'],
  ...
  {
    title: 'Configuração incorreta de CORS', cwe: ['942'], owasp: ['5'],
  ...
  {
    title: 'Interface sensível exposta', cwe: ['200', '538'], owasp: ['5', '1'],
  ...
  {
    title: 'Cabeçalhos de segurança ausentes', cwe: ['693'], owasp: ['5'],
  ...
  {
    title: 'Subdomain takeover', owasp: ['5'],
  ...
  {
    title: 'Serviço/porta exposta', owasp: ['5'],
  ...
  {
    title: 'Fraqueza de TLS/SSL', cwe: ['326', '327'], owasp: ['2'],
  ...
  {
    title: 'Vazamento de informação', cwe: ['200'], owasp: ['5', '1'],
  ...
  {
    title: 'Credenciais padrão ou fracas', cwe: ['521', '1392'], owasp: ['7'],
  ...
  {
    title: 'Server-Side Request Forgery (SSRF)', cwe: ['918'], owasp: ['10'],
  ...
  {
    title: 'Controle de acesso quebrado (IDOR)', cwe: ['639', '284'], owasp: ['1'],
  ...
  {
    title: 'Componente desatualizado (CVE conhecido)', cwe: ['1104', '937'], owasp: ['6'],
  ...
  {
    title: 'Listagem de diretórios', cwe: ['548'], owasp: ['5'],
  ...
  {
    title: 'Exposição de segredo', cwe: ['540', '312'], owasp: ['2'],
  ...
  {
    title: 'Redirecionamento aberto', cwe: ['601'], owasp: ['1'],
  ...
  {
    title: 'Clickjacking', cwe: ['1021'], owasp: ['5'],
...
export function lessonFor(finding: Pick<Finding, 'title' | 'type' | 'cwe' | 'owasp'>): VulnLesson {
  const toLesson = (e: KbEntry): VulnLesson => ({ title: e.title, why: e.why, where: e.where, impact: e.impact, matched: true })
